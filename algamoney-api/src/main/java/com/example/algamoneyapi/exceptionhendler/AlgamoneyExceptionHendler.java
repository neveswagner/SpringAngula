package com.example.algamoneyapi.exceptionhendler;
...
public class AlgamoneyExceptionHendler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
		...
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
		return handleExceptionInternal(null, erros, new HttpHeaders() ,HttpStatus.NOT_FOUND, request);
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		...
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
		return handleExceptionInternal(null, erros, new HttpHeaders() ,HttpStatus.BAD_REQUEST, request);
