...
public class CorsFilter implements Filter {
	...
	private String originPermitido = "http://localhost:8080"; //TODO: Configurar para diferentes ambientes
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		if ("OPTIONS".equals(request.getMethod()) && originPermitido.equals(request.getHeader("Origin"))) {
			...
			response.setHeader("Acess-Control-Allow-Headers", "Authorization, Content-Type, Acept");
